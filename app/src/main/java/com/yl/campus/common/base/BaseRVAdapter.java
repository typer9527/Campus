...
public abstract class BaseRVAdapter<T> extends
    ...
    public BaseRVAdapter(List<T> dataList, int itemLayoutId,
    ...
    public abstract void bindItemLayout(BaseRVAdapter.BaseViewHolder holder, T data);

    public abstract void bindHeaderLayout(BaseRVAdapter.BaseViewHolder holder);

    public abstract void bindFooterLayout(BaseRVAdapter.BaseViewHolder holder);
    ...
    public void onViewAttachedToWindow(BaseRVAdapter.BaseViewHolder holder) {
